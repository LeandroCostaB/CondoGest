CREATE TYPE "public"."role" AS ENUM('SINDICO', 'MORADOR');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "condominium" ADD CONSTRAINT "condominium_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
