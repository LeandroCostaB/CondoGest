...
--> statement-breakpoint
INSERT INTO "apartment" ("id", "number", "block", "floor", "condominium_id", "created_at", "updated_at")
VALUES
  ('a9dd0e45-dbfb-4b34-a41e-3d12cfb1f1ce', '101', 'A', 1, 'fe8692cb-8a62-4d2a-909b-124d60dac753', NOW(), NOW()),
  ('b2c3d4e5-f6a7-8901-bcde-f12345678901', '201', 'A', 2, 'fe8692cb-8a62-4d2a-909b-124d60dac753', NOW(), NOW()),
  ('c3d4e5f6-a7b8-9012-cdef-012345678902', '102', 'B', 1, 'fe8692cb-8a62-4d2a-909b-124d60dac753', NOW(), NOW()),
  ('d4e5f6a7-b8c9-0123-def0-123456789012', '202', 'B', 2, 'fe8692cb-8a62-4d2a-909b-124d60dac753', NOW(), NOW())
ON CONFLICT DO NOTHING;
