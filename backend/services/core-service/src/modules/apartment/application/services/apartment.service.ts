...
export class ApartmentService {
  ...
  async create(
    ...
    await this.messagingService.publishCoreEvent(CoreEventName.APARTAMENTO_CRIADO, {
      id: created.id,
  ...
  async update(
    ...
    await this.messagingService.publishCoreEvent(CoreEventName.APARTAMENTO_ATUALIZADO, {
      id: apartment.id,
  ...
  async delete(
    ...
    await this.messagingService.publishCoreEvent(CoreEventName.APARTAMENTO_DELETADO, { id: apartmentId });
  }
