...
export class User {
  ...
  get fcmToken(): string | null | undefined { return this._fcmToken; }
  get createdAt(): Date | undefined { return this._createdAt; }
  get updatedAt(): Date | undefined { return this._updatedAt; }

  withNome(nome: string) { this._nome = nome; return this; }
  withEmail(email: string) { this._email = email; return this; }
  withSenha(senha: string) { this._senha = senha; return this; }
  withRole(role: UserRole) { this._role = role; return this; }
  withFcmToken(token: string | null) { this._fcmToken = token; return this; }
  ...
  static restore(props?: {
    ...
    user._fcmToken = props.fcmToken ?? null;
    return user;
  }
}
