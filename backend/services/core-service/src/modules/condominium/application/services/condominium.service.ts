...
export class CondominiumService {
  ...
  async create(dto: CreateCondominiumDto, userId: string): Promise<void> {
    ...
    await this.messagingService.publishCoreEvent(CoreEventName.CONDOMINIO_CRIADO, {
      id: created.id,
      name: created.name,
  ...
  async update(
    ...
    await this.messagingService.publishCoreEvent(CoreEventName.CONDOMINIO_ATUALIZADO, {
      id: condominium.id,
  ...
  async delete(id: string, userId: string): Promise<void> {
    ...
    await this.messagingService.publishCoreEvent(CoreEventName.CONDOMINIO_DELETADO, { id });
  }
