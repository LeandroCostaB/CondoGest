...
export class CondominiumsController {
  ...
  @ApiOkResponse({ description: "Lista de condomínios", type: [CondominiumDto] })
  ...
  @ApiOkResponse({ description: "Condomínio encontrado", type: CondominiumDto })
  ...
  @ApiCreatedResponse({ description: "Condomínio criado", type: CondominiumDto })
  @ApiUnauthorizedResponse({ description: "Token ausente ou inválido" })
  @ApiForbiddenResponse({ description: "Sem permissão" })
  ...
  @ApiOkResponse({ description: "Condomínio atualizado", type: CondominiumDto })
  @ApiNotFoundResponse({ description: "Condomínio não encontrado" })
  @ApiUnauthorizedResponse({ description: "Token ausente ou inválido" })
  @ApiForbiddenResponse({ description: "Sem permissão" })
  @RequirePermissions(Permission.CONDOMINIUMS_WRITE)
